...
/**
 * ActionsPaymentSchedule Class
 *
 * Hook actions for PaymentSchedule module
 */
class ActionsPaymentSchedule extends paymentschedule\RetroCompatCommonHookActions
{
	...
	/**
	 * Hook to print values in list fields
	 *
	...
	/**
	 * Hook to print titles in list fields
	 *
	 * @param   array           $parameters     Hook metadatas
	 * @param   CommonObject    $object         The object to process
	 * @param   string          $action         Current action
